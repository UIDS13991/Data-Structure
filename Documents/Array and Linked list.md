...
<br>که آن را با نام `next` به `node` بعدی متصل شده است.(مانند شکل زیر) <br><br>
...
به عبارت دیگر بر خلاف آرایه دیگر با کمک ایندکس نمیتوانیم به اطالاعات هر خانه دسترسی پیدا کنیم.
